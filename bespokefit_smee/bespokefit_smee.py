...
def cli():
    ...
    parser.add_argument(
        "--smiles", type=str, help="SMILES string", required=True, default=None
    )
    parser.add_argument(
        "--method",
        type=str,
        help="Method for generating data",
        required=False,
        default="MMMD",
    )
    parser.add_argument(
        "--N_epochs",
        type=int,
        help="Number of epochs in the ML fit",
        required=False,
        default=1000,
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
        help="Learning Rate in the ML fit",
        required=False,
        default=0.1,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--loss_force_weight",
        type=float,
        help="Scaling Factor for the Force loss term",
        required=False,
        default=1e5,
    )
    parser.add_argument(
        "--force_field_init",
        type=str,
        help="Starting guess force field",
        required=False,
    ...
    parser.add_argument(
        "--MLMD_potential",
        type=str,
        help="Name of the MD potential used",
        required=False,
    ...
    parser.add_argument(
        "--N_train",
        type=int,
        help="Number of datapoints in training sets",
        required=False,
        default=1000,
    )
    parser.add_argument(
        "--N_test",
        type=int,
        help="Number of datapoints in testing sets",
        required=False,
        default=1000,
    )
    parser.add_argument(
        "--N_conformers",
        type=int,
        help="Number of Starting Conformers",
        required=False,
        default=10,
    )
    parser.add_argument(
        "--N_iterations",
        type=int,
        help="Number of ML Iterations Performed",
        required=False,
        default=5,
    )
    parser.add_argument(
        "--MD_stepsize",
        type=int,
        help="Number of Time Steps Between MD Snapshots",
        required=False,
        default=10,
    )
    parser.add_argument(
        "--MD_startup",
        type=int,
        help="Number of Time Steps Ignored",
        required=False,
        default=100,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--MD_dt",
        type=float,
        help="MD Stepsize in femtoseconds",
        required=False,
        default=1.0,
    )
    parser.add_argument(
        "--MD_energy_lower_cutoff",
        type=float,
        help="Lower bound for the energy cutoff function",
        required=False,
        default=1.0,
    )
    parser.add_argument(
        "--MD_energy_upper_cutoff",
        type=float,
        help="Upper bound for the energy cutoff function",
        required=False,
        default=10.0,
    )
    parser.add_argument(
        "--Cluster_tolerance",
        type=float,
        help="Tolerance used in the RMSD clustering",
        required=False,
        default=0.075,
    )
    parser.add_argument(
        "--Cluster_Parallel",
        type=int,
        help="MPI nodes used in the RMSD clustering",
        required=False,
        default=1,
    )
    parser.add_argument(
        "--data",
        type=str,
        help="Location of pre-calculated data set",
        required=False,
        default="train_data",
    )
    parser.add_argument(
        "--modSem_finite_step",
        type=float,
        help="Finite Step to Calculate Hessian in Ang",
        required=False,
        default=0.005291772,
    )
    parser.add_argument(
        "--modSem_vib_scaling",
        type=float,
        help="Vibrational Scaling Parameter",
        required=False,
        default=0.957,
    )
    parser.add_argument(
        "--modSem_tolerance",
        type=float,
        help="Tolerance for the geometry optimizer",
        required=False,
        default=0.0001,
    )
    parser.add_argument(
        "--memory", action="store_true", help="Retain data upon iteration (Default)"
    )
    parser.add_argument(
        "--no-memory",
        dest="memory",
    ...
    parser.add_argument(
        "--linear_harmonics",
        action="store_true",
        help="Linearize the Harmonic potentials in the Force Field (Default)",
    )
    parser.add_argument(
        "--no-linear_harmonics",
        dest="linear_harmonics",
        action="store_false",
        help="Don't Linearize the Harmonic potentials in the Force Field",
    )
    parser.set_defaults(linear_harmonics=True)
    parser.add_argument(
        "--linear_torsions",
        action="store_true",
        help="Linearize the Torsion potentials in the Force Field (Default)",
    )
    parser.add_argument(
        "--no-linear_torsions",
        dest="linear_torsions",
        action="store_false",
        help="Don't Linearize the Torsion potentials in the Force Field",
    )
    parser.set_defaults(linear_torsions=True)
    parser.add_argument(
        "--modSem",
        action="store_true",
        help="Use mod-Seminario method to initialize the Force Field (Default)",
    )
    parser.add_argument(
        "--no-modSem",
        dest="modSem",
        action="store_false",
        help="Don't use mod-Seminario method to initialize the Force Field",
    )
