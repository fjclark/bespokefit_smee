...
To stabilize and speed up convergence of the parameter fitting, these potentials are *linearized*. The linearization of the harmonic terms followed the approach by [espaloma](https://doi.org/10.1039/D2SC02739A), where the minimum is assumed to be within a window given by $x_1$ and $x_2$, such that the fitting parameters may by remapped onto linear terms,

$k_1=k\frac{x_2-x_0}{x_2-x_1}$ and $k_2=k\frac{x_0-x_1}{x_2-x_1}$

These terms are give the original parameters via,

$k=k_1+k_2$ and $x_0=\frac{k_1x_1+k_2x_2}{k_1+k_2}$
